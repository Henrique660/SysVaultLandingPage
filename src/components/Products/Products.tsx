...
import imgBarbearia from "../../img/produto 4.png";
...
const PRODUCTS: ProductData[] = [
  ...
  },
  {
    ...
    description:
      "Estoque, vendas, cadastro de colaboradores, registro de ponto com integração mobile e muito mais.",
  ...
  {
    number: "04 — Barbearia digital",
    title: "Agendamento e gestão para barbearias.",
    description:
      "Um sistema completo para conectar clientes, barbeiros e gestão: agendamentos, profissionais, horários e operação em uma experiência simples.",
    caps: ["Agendamento online", "Gestão de profissionais", "PWA mobile"],
    chip: "Barbearia digital",
    figure: "FIG. 05 — Plataforma de agendamento e gestão",
    visual: <img src={imgBarbearia} alt="Painel administrativo do software para barbearias" className="product-img" />,
  },
];
          ...
          {PRODUCTS.map((product, i) => (
            ...
            >
              <div className="product-meta">
                ...
                {product.number.startsWith("04") && (
                  <a className="link-arrow product-detail-link" href="/barbearia">
                    Ver case da barbearia
                    <ArrowIcon />
                  </a>
                )}
              </div>
